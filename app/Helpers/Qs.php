...
class Qs
{
    ...
    {
        return self::getSetting('system_title') ?: 'Joe';
    }
 ...
 <div class="alert alert-success alert-bordered">
    ...
    {
        $data = ['name', 'email', 'phone', 'phone2', 'dob', 'gender', 'address', 'bg_id', 'nal_id', 'state_id', 'city_id'];
    ...
    {
       switch($class_type){
           case 'PT-SA' : return 'part-time skill acquisition';
           case 'PT-PD' : return 'part-time ph.d';
           case 'PT-D' : return 'part-time diploma';
           case 'PT-M' : return 'part-time masters';
           case 'PT-B' : return 'part-time bachelors';
       }
        return $class_type;
    }
