<script>
    function getCities(state_id){
        var url = '{{ route('get_cities', ':id') }}'.replace(':id', state_id);
        var city = $('#city_id');
    ...
    function getClassSections(class_id, destination){
        var url = '{{ route('get_class_sections', ':id') }}'.replace(':id', class_id);
    ...
    function getClassSubjects(class_id){
        var url = '{{ route('get_class_subjects', ':id') }}'.replace(':id', class_id);
