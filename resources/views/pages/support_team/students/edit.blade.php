                ...
                <fieldset>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <select onchange="getCities(this.value)" required data-placeholder="Choose.." class="select-search form-control" name="state_id" id="state_id">
                                <option value=""></option>
                        ...
                        <div class="col-md-3">
                            ...
                            <select required data-placeholder="Select State First" class="select-search form-control" name="city_id" id="city_id">
                                @if($sr->user->city_id)
                                    <option selected value="{{ $sr->user->city_id }}">{{ $sr->user->city->name}}</option>
                                @endif
                            </select>
                        </div>
