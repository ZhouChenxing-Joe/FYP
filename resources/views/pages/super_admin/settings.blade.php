                            ...
                            <div class="col-lg-9">
                                <select data-placeholder="Choose..." required name="current_session" id="current_session" class="select-search form-control">
                                    ...
                                    @for($y=date('Y', strtotime('- 3 years')); $y<=date('Y', strtotime('+ 1 years')); $y++)
                                        <option {{ ($s['current_session'] ?? '') == (($y-1).'-'.$y) ? 'selected' : '' }}>{{ ($y-1).'-'.$y }}</option>
                                    @endfor
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-3">
                                <select class="form-control select" name="lock_exam" id="lock_exam">
                                    <option {{ ($s['lock_exam'] ?? 0) == 1 ? 'selected' : '' }} value="1">Yes</option>
                                    <option {{ ($s['lock_exam'] ?? 0) == 0 ? 'selected' : '' }} value="0">No</option>
                                </select>
                            </div>
                            <div class="col-lg-6">
